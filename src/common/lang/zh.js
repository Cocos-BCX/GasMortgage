export const langZh = {
    business:{
        ...
        Others: '他人',
        NextStep: '下一步',
        NoGASCouldBeReceived: '无可领取GAS',
        SuccessfulReceiving: '领取成功',
        FailedToReceive: '领取失败',
        MortgageQuantityMustBeGreaterThanZero: '抵押数量必须大于零',
        MortgageValueIsNotEnough: '抵押值不足',
        SuccessfulMortgage: '抵押成功',
        FailedToMortgage: '抵押失败',
