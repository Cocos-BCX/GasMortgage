export const langEn = {
    business:{
        ...
        Others: 'Others',
        NextStep: 'Next step',
        NoGASCouldBeReceived: 'No GAS could be received',
        SuccessfulReceiving: 'Successful receiving',
        FailedToReceive: 'Failed to receive',
        MortgageQuantityMustBeGreaterThanZero: 'Mortgage quantity must be greater than zero',
        MortgageValueIsNotEnough: 'Mortgage value is not enough',
        SuccessfulMortgage: 'Successful mortgage',
        FailedToMortgage: 'Failed to mortgage',
